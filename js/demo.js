$(document).ready(function() {
	...
	$('.wrapper-simple input[type=submit]').toggle(function(){
		...
		$('.wrapper-simple').animate({'width':'350px'})
				  .end().find('.wrapper-simple input[type=text]').animate({'width': '350px'})
				  .end().find('.wrapper-simple img').animate({'marginLeft': '-5px'})
				  .end().find(this).animate({'marginLeft':'55px'}).attr('value', 'x');
		
	}, function() {
		
		$('.arrow2').show();
		$('.wrapper-simple').animate({'width':'44px'})
				  .end().find('.wrapper-simple input[type=text]').animate({'width': '1px'})
				  .end().find('.wrapper-simple img').animate({'marginLeft': '0'})
				  .end().find(this).animate({'margin':'0'}).attr('value', '');
	...
	$('.search-button2').click(function() {
		...
		$(this).stop().animate({'width':'350px'}, 500, function() {
